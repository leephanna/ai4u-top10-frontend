...
function App() {
  ...
  // Dynamic API URL - uses backend API, NOT Rainforest API directly
  const API_URL = process.env.NODE_ENV === 'production' 
    ? 'https://ai4u-top10-backend.vercel.app/api/generate-list'
    : 'http://127.0.0.1:5000/api/generate-list';

  // Generate list function - calls the backend API
  const generateList = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setError(data.error || "Failed to generate list. Please try again.");
        setResult(null);
      }
    } catch (error) {
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{ fontWeight: '600', marginBottom: '8px', margin: '0 0 8px 0' }}>🎯 Unlimited Categories</h3>
          ...
          <div style={{
            ...
            <h3 style={{ fontWeight: '600', marginBottom: '8px', margin: '0 0 8px 0' }}>✅ Real Amazon Data</h3>
          ...
          <div style={{
            ...
            <h3 style={{ fontWeight: '600', marginBottom: '8px', margin: '0 0 8px 0' }}>💰 Revenue Ready</h3>
